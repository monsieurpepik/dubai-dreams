    ...
    >
      ...
      <div ref={ref} className="container-custom relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          {/* Off-Plan Ownership - Blue border glow */}
          <motion.div
            className="relative bg-card/50 p-8 lg:p-12 border border-accent/30 overflow-hidden shadow-[0_0_60px_-15px_hsl(var(--accent)/0.3)]"
            initial={{ opacity: 0, x: 60 }}
            animate={inView ? { opacity: 1, x: 0 } : {}}
          ...
          >
            ...
            {/* Badge */}
            <div className="absolute top-6 right-6 bg-accent text-accent-foreground text-xs font-medium px-4 py-2 uppercase tracking-wider">
              Recommended
            </div>
            ...
            <div className="space-y-4 mb-8">
              <motion.div 
                className="flex items-center justify-between p-5 bg-accent/5 border border-accent/20"
              ...
              >
                <div>
                  ...
                  <p className="text-3xl font-light text-accent">AED 150K</p>
                </div>
                <div className="text-right">
                  <p className="text-xs text-muted-foreground">10% deposit</p>
                  <p className="text-accent text-sm font-medium">Start here</p>
                </div>
              </motion.div>
        ...
        >
          <p className="text-3xl md:text-5xl lg:text-6xl font-extralight tracking-tight">
            Own <span className="text-foreground font-light drop-shadow-[0_0_20px_hsl(var(--accent)/0.4)]">100%</span>
            <span className="text-muted-foreground"> · </span>
            Pay <span className="text-foreground font-light drop-shadow-[0_0_20px_hsl(var(--accent)/0.4)]">20%</span> over 3 years
          </p>
        </motion.div>
      </div>
    </section>
