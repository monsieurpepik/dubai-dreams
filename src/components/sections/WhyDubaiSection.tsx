  ...
  return (
    <section ref={containerRef} className="relative bg-black">
      ...
      <div className="sticky top-0 z-10 pt-32 pb-8 pointer-events-none bg-black/80 backdrop-blur-sm">
        <div className="container-wide">
          <motion.p
            ...
            className="text-[10px] font-medium uppercase tracking-[0.05em] text-white/50"
          >
            Why Dubai
          </motion.p>
        </div>
      ...
      {benefits.map((benefit, index) => (
        <div key={benefit.title} className="min-h-screen flex items-center relative bg-black">
          ...
          <div className="container-wide relative z-10 py-20">
            <div className="max-w-4xl">
              ...
              >
                {/* Massive stat */}
                <span className="text-[8rem] md:text-[12rem] lg:text-[16rem] text-white leading-none block">
              ...
              >
                <h3 className="text-[10px] font-medium uppercase tracking-[0.05em] text-white/50 mb-4">
                  {benefit.title}
                </h3>
                <p className="text-xl md:text-2xl text-white/70 font-light max-w-lg leading-relaxed">
                  {benefit.description}
                </p>
              </motion.div>
            </div>
      ...
      <div className="py-20 text-center bg-black">
        <motion.a
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="inline-flex items-center gap-2 text-xs font-medium uppercase tracking-[0.05em] text-white/70 hover:text-white transition-colors"
        >
          Learn More
