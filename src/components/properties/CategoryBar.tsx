...
export const CategoryBar = ({ active, onChange }: CategoryBarProps) => {
  ...
  return (
    <div className="border-b border-border/30 sticky top-14 md:top-20 z-30 bg-background/95 backdrop-blur-sm">
          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`relative flex items-center gap-2 px-4 py-3 min-h-[44px] text-sm whitespace-nowrap transition-colors shrink-0 ${
                  isActive
                    ? 'text-foreground'
