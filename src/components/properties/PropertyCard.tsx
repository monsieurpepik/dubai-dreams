...
export const PropertyCard = ({ property, index }: PropertyCardProps) => {
  return (
    <motion.div
      ...
      className="group relative bg-card rounded-xl overflow-hidden border border-border/50 hover:border-accent/50 transition-all duration-300 hover:shadow-xl hover:shadow-accent/5"
    >
      {/* Image Section */}
